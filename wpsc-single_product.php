					...
					<div class="productcol">						
                        ...
                        <div class="price_display <?php echo $onsale; ?>">
                            <?php if(wpsc_product_on_special()) : ?>
                               <div class="price-display-position">
                               <span class="pricedisplay"><?php echo wpsc_product_normal_price(); ?></span><br /><span class="pricedisplay new"><?php echo wpsc_the_product_price(); ?></span>
                               </div><!--close pricedisplay-->
                            <?php else : ?>
                            	<div class="price-display-position">
                            	<span class="pricedisplay"><?php echo wpsc_the_product_price(); ?></span>
                                </div><!--close pricedisplay-->
                            <?php endif; ?>
